...
path = '/gpfs/projects/MirandaGroup/josh/github/cocoa2/Cocoa/external_modules/data/planck/plc_3.0/hi_l/plik_lite/'
...
copy_clik = 'cp -R '+path+'plik_lite_v22_TT_copy.clik/ '+path+label+'.clik'
#print(copy_clik)
os.system(copy_clik)
#print('done')
